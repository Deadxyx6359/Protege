...
Reuses ``akira.models`` for the backend protocol and the llama.cpp binding —
...
from akira.models.base import ModelBackend, ModelSpec, ModelUnavailable, Role
...
class ModelRouter:
    ...
    def _backend_module():
        ...
        `akira.models.llama_backend` does `import llama_cpp` at module scope,
