...
**Proposals wait outside the vault**, in Akira's configuration folder, where
...
from akira.core.schedule import (ActionRegistry, ActionResult, Daily, Job, JobContext, JobGrant,
                                   Missed, Scheduler)
from akira.models.base import ChatMessage, ModelError
...
class _Stopped(Exception):
    """Raised from the token stream to end a generation Akira is closing on."""
