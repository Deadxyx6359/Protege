...
def configure_application(app: QGuiApplication) -> None:
    ...
    app.setApplicationName("Protégé")
    app.setOrganizationName("Protégé")
    ...
    app.setDesktopFileName("protege")
...
def build_engine(
    *,
    ...
    """Create an engine with Protégé's QML module and bridges registered.
