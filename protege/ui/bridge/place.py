...
`protege.core.context.place`. The scenes use its hemisphere to turn the seasons
...
from protege.core.context.place import (MAX_NAME_CHARS, PlaceError, PlaceStore, check_place,
                                        season)
from protege.core.context.weather import SITE, Found, Weather, WeatherError
