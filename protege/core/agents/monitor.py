...
page looked at hourly would otherwise miss a change made while Protégé was
...
from protege.core.net import NetError, fetchable, host_of, redact
from protege.core.net import fetch as net_fetch
