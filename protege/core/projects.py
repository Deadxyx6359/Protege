...
B6. Supersedes the legacy `protege/projects.py` for the new application; the
...
**Nothing here deletes notes.** Removing a project removes Protégé's record of it
...
from protege.core.permissions.model import Decision, Grant
