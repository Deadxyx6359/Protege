...
local index (`protege.core.brain.index`), ranked by section, and hand back the
...
from protege.core.brain import Index, Result, VaultError
from protege.core.brain.corpora import TEXT_SUFFIXES, ConversationArchive, DocumentFolder
