...
The vault is a plain directory of markdown. Obsidian is optional -- Protege
...
# state; indexing either would feed Protege its own configuration as knowledge.
...
def render_note(topics: Sequence[str], body: str, extra: dict | None = None) -> str:
    """Serialize a note with frontmatter, for anything Protege writes.
